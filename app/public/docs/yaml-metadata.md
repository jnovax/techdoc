...
The original markdown syntax breaks only if you put space twice, but TechDoc choose to breaks every time you enter a break.
...
The current stable version of TechDoc uses Reveal 3.
